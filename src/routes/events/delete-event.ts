...
import { eventPathParamsSchema, notFoundSchema, errorSchema } from '../../schemas'
import { prisma } from '../../utils/prisma'

// Define the DELETE /events/:eventId route
export const deleteEventRoute: RouteConfig<typeof eventPathParamsSchema, undefined, undefined> = {
	method: 'delete',
	path: '/events/:eventId',
	openapi: {
