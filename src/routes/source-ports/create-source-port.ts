...
import { sourcePortPostRequestBodySchema, sourcePortSuccessResponseSchema, errorSchema } from '../../schemas'
import { prisma } from '../../utils/prisma'

// Define the POST /source-ports route
export const createSourcePortRoute: RouteConfig<undefined, undefined, typeof sourcePortPostRequestBodySchema> = {
	method: 'post',
	path: '/source-ports',
	openapi: {
