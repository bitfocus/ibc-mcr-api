...
import { sourcePortPathParamsSchema, sourcePortSuccessResponseSchema, notFoundSchema, errorSchema } from '../../schemas'
import { prisma } from '../../utils/prisma'

// Define the GET /source-ports/:sourcePortId route
export const getSourcePortRoute: RouteConfig<typeof sourcePortPathParamsSchema, undefined, undefined> = {
	method: 'get',
