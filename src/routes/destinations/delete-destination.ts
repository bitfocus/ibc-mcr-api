...
import { destinationPathParamsSchema, notFoundSchema, errorSchema } from '../../schemas'
import { prisma } from '../../utils/prisma'

// Define the DELETE /destinations/:destinationId route
export const deleteDestinationRoute: RouteConfig<typeof destinationPathParamsSchema, undefined, undefined> = {
	method: 'delete',
