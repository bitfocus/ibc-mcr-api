...
import { partylinePathParamsSchema, notFoundSchema, errorSchema } from '../../schemas'
import { prisma } from '../../utils/prisma'

// Define the DELETE /partylines/:partylineId route
export const deletePartylineRoute: RouteConfig<typeof partylinePathParamsSchema, undefined, undefined> = {
	method: 'delete',
