...
import { sourcePathParamsSchema, sourceSuccessResponseSchema, notFoundSchema, errorSchema } from '../../schemas'
import { prisma } from '../../utils/prisma'

// Define the GET /sources/:sourceId route
export const getSourceRoute: RouteConfig<typeof sourcePathParamsSchema, undefined, undefined> = {
	method: 'get',
